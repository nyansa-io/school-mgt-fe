...
const EventDetailsView = () => {
    return (
        <div className='eventDetailsView rounded-lg bg-white md:border p-4'>
            ...
            <div className="eventPresenceType mt-4">
            ...
            <div className="eventLocationNDescription grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                {/* location  */}
